class CompaniesController < ApplicationController
  ...
  def index
    ...
    # All comapanies have relationship to jobs, and the ensure we are not repeated
    ...
    #Companies either om tje ecommerce or utility
    @union_companies = @ecomerce_companies | @utility_companies
