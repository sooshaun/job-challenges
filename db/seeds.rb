...
zendesk = Company.create!(name: 'Zenesk', industry: 'productivity')
...
[xero, envato, zendesk, atlassian, cba].each do |company|
    ...
    Job.create!(company: company, title: 'Full Stack Rails Developer', front_end: true, back_end: true, description: 'Rspec + HTML + CSS')
